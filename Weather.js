document.addEventListener("DOMContentLoaded", function(){
  ...
  map.on('load', () => {
    ...
    //SECTION 2: WEATHER CODE

    //initialize reader in global scope for parsing JSON code- try initializing in local
    let reader;

    function fetchWeather(lat, long, units){
      console.log("fetching weather now!!!")
      console.log(units);
      //COPY AND PASTE WEATHER FETCHING STUFF HERE
